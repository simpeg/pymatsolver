...
class Mumps(Base):
    ...
    def _funhandle(self, ftype):
        ...
        if self.A.dtype == float:
            return {'F': MumpsInterface.factor_mumps,
                    'S': MumpsInterface.solve_mumps,
                    'D': MumpsInterface.destroy_mumps}[ftype]
        elif self.A.dtype == complex:
            return {'F': MumpsInterface.factor_mumps_cmplx,
                    'S': MumpsInterface.solve_mumps_cmplx,
                    'D': MumpsInterface.destroy_mumps_cmplx}[ftype]
